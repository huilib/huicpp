...
type_test:
	@if [ "$(TTYPE)" = "AFILE" ]; then mkdir -p ${LIB_PATH}; echo "\033[33m=====>We Are Compiling static Library File: ${TARGET}\033[0m";  fi
	@if [ "$(TTYPE)" = "EFILE" ]; then mkdir -p ${BIN_PATH}; echo "\033[33m=====>We Are Compiling Execute File: ${TARGET}\033[0m"; fi
	@if [ "$(TTYPE)" = "SFILE" ]; then mkdir -p ${LIB_PATH}; echo "\033[33m=====>We Are Compiling Share library File: ${TARGET}\033[0m"; fi
